...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            var c = a(this), e = c.data("bs.button"), f = "object" == typeof b && b;
    ...
    d.VERSION = "3.2.0", d.DEFAULTS = {loadingText: "loading..."}, d.prototype.setState = function (b) {
    ...
    var e = a.fn.button;
    a.fn.button = b, a.fn.button.Constructor = d, a.fn.button.noConflict = function () {
    ...
    c.VERSION = "3.2.0", c.prototype.show = function () {
        ...
        var f = c.find("> .active"), g = d && a.support.transition && (f.length && f.hasClass("fade") || !!c.find("> .fade").length);
    ...
    c.VERSION = "3.2.0", c.RESET = "affix affix-top affix-bottom", c.DEFAULTS = {offset: 0, target: window}, c.prototype.getPinnedOffset = function () {
        ...
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== i) {
                ...
                this.$element.trigger(k), k.isDefaultPrevented() || (this.affixed = i, this.unpin = "bottom" == i ? this.getPinnedOffset() : null, this.$element.removeClass(c.RESET).addClass(j).trigger(j.replace("affix", "affixed") + ".bs.affix"), "bottom" == i && this.$element.offset({top: b - this.$element.height() - h}))
            }
        }
    };
    var d = a.fn.affix;
